         	...
         	<?php 
         		foreach($curso as $c){
         			echo '<tr>';
         				...
         				echo '<td><a href="listaPresenca.php?id='.$c->getIdCurso().'" target="_blank" class="ls-ico-eye ls-btn" title="Ver Lista"></a> | <a href="lancaPresenca.php?id='.$c->getIdCurso().'" class="ls-ico-pencil2 ls-btn" title="Lançar"></a></td>';
